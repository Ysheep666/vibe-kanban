...
- Follow the [Orchestrator Pattern tutorial](/integrations/mcp-orchestrator-pattern) to let a parent coding agent spawn and supervise child tasks through the Vibe Kanban MCP server
